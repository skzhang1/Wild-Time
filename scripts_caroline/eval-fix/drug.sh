...
python main.py --dataset=drug --method=si --si_c=0.1 --epsilon=0.001 --offline --lr=5e-5 --mini_batch_size=256 --train_update_iter=5000 --split_time=2016 --data_dir=./Data/Drug-BA --random_seed=1
python main.py --dataset=drug --method=si --si_c=0.1 --epsilon=0.001 --offline --lr=5e-5 --mini_batch_size=256 --train_update_iter=5000 --split_time=2016 --data_dir=./Data/Drug-BA --random_seed=2
python main.py --dataset=drug --method=si --si_c=0.1 --epsilon=0.001 --offline --lr=5e-5 --mini_batch_size=256 --train_update_iter=5000 --split_time=2016 --data_dir=./Data/Drug-BA --random_seed=3
