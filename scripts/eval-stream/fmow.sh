...
#LISA
python main.py --dataset=fmow --method=erm --lisa --eval_next_timesteps=6 --mini_batch_size=64 --train_update_iter=500 --lr=1e-4 --weight_decay=0.0 --split_time=7 --num_workers=8 --random_seed=1 --log_dir=./checkpoints
