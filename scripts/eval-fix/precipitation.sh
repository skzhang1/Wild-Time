...
#EWC
python main.py --dataset=precipitation --method=ewc --ewc_lambda=0.1 --online --offline --mini_batch_size=128 --train_update_iter=5000 --lr=0.001 --split_time=7 --random_seed=1 --log_dir=./checkpoints

#Fine-tuning
python main.py --dataset=precipitation --method=ft --offline --mini_batch_size=128 --train_update_iter=5000 --lr=0.001 --split_time=7 --random_seed=1 --log_dir=./checkpoints

#SI
python main.py --dataset=precipitation --method=si --si_c=0.1 --epsilon=0.001 --offline --mini_batch_size=128 --train_update_iter=5000 --lr=0.001 --split_time=7 --random_seed=1 --log_dir=./checkpoints
