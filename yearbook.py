...
# CFO
arcs_config1 = {'lr': 0.0015279350754884976, 'batch_size': 128, 'iteration_limit': 3565, 'n_conv_channels_c1': 48, 'kernel_size_c1': 3, 'n_conv_channels_c2': 40, 'kernel_size_c2': 3, 'n_conv_channels_c3': 138, 'kernel_size_c3': 3, 'n_conv_channels_c4': 16, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}  # 0.16521890074299056                                                                                                                                                                                                          
arcs_config2 = {'lr': 0.05683596083135141, 'batch_size': 32, 'iteration_limit': 3000, 'n_conv_channels_c1': 18, 'kernel_size_c1': 3, 'n_conv_channels_c2': 24, 'kernel_size_c2': 3, 'n_conv_channels_c3': 40, 'kernel_size_c3': 3, 'n_conv_channels_c4': 26, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}# 
arcs_config3 = {'lr': 0.01558630718360578, 'batch_size': 64, 'iteration_limit': 4075, 'n_conv_channels_c1': 22, 'kernel_size_c1': 3, 'n_conv_channels_c2': 22, 'kernel_size_c2': 3, 'n_conv_channels_c3': 18, 'kernel_size_c3': 3, 'n_conv_channels_c4': 24, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}

# lexico_worst
# arcs_config1 =  {'lr': 0.01488692280877379, 'batch_size': 32, 'iteration_limit': 3404, 'n_conv_channels_c1': 50, 'kernel_size_c1': 3, 'n_conv_channels_c2': 26, 'kernel_size_c2': 3, 'n_conv_channels_c3': 22, 'kernel_size_c3': 3, 'n_conv_channels_c4': 16, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}
# arcs_config2 = {'lr': 0.1, 'batch_size': 32, 'iteration_limit': 3639, 'n_conv_channels_c1': 32, 'kernel_size_c1': 3, 'n_conv_channels_c2': 24, 'kernel_size_c2': 3, 'n_conv_channels_c3': 34, 'kernel_size_c3': 3, 'n_conv_channels_c4': 18, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}
# arcs_config3 = {'lr': 0.1, 'batch_size': 64, 'iteration_limit': 3000, 'n_conv_channels_c1': 38, 'kernel_size_c1': 3, 'n_conv_channels_c2': 24, 'kernel_size_c2': 3, 'n_conv_channels_c3': 18, 'kernel_size_c3': 3, 'n_conv_channels_c4': 16, 'kernel_size_c4': 3, 'has_max_pool_c1': 1, 'has_max_pool_c2': 1, 'has_max_pool_c3': 1, 'has_max_pool_c4': 1}

test_config = []
test_config.append(arcs_config1)
test_config.append(arcs_config2)
test_config.append(arcs_config3)
...
for i, config in enumerate(test_config):
    ...
    # lisa["seed"] = i+2
    result = evaluate_function(lisa, config)
    loss_list.append(1-result["val_loss"])
    worst_list.append(1-result["worst"])
    folds_list.append([1-k for k in result["folds"]])

print(loss_list)
print(np.mean(loss_list))
print(np.mean(worst_list))
print(np.mean(folds_list, axis=0))
